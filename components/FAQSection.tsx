...
const items = [
  ...
  ['Can I take it back?', 'Yes. Open Your links and cancel any unclaimed link to recover your USDC.'],
  ...
  ['Can I recover my links?', 'Use the same sending wallet in Your links to recover securely backed-up links on another device.'],
